$(document).ready(() => {
  ...
  const measureRadiation = (radiation_uv) => {
    let medidor_uv = d3.arc()
      .innerRadius(80)
      .outerRadius(100)
      .startAngle((Math.PI / 4) * 5)
      .endAngle((Math.PI / 4) * scaleRadiation(radiation_uv))
      .cornerRadius(20);

    return medidor_uv;
  }
  const stateRadiation = (radiation_lvl, data) => {
  ...
  let measure = d3.arc()
    ...
    .outerRadius(100)
    .startAngle((Math.PI / 4) * 5)
    .endAngle((Math.PI / 4) * 11)
    .cornerRadius(20);
  let measure_uv = measureRadiation(radiation.now);
  let svgContainer = d3.select("#medidor")
    .append("svg")
    .attr("width", radiation.size)
    .attr("height", radiation.size);

  svgContainer.append("text")
    .attr("id", "radiationNow")
  ...
  let times = [3000,6000,9000,12000,15000,18000,21000,24000,27000,300000,33000,36000,39000];
